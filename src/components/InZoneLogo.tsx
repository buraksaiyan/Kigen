...
interface InZoneLogoProps {
  size?: 'small' | 'medium' | 'large';
  showJapanese?: boolean;
  showText?: boolean; // New prop to show/hide the "InZone" text
  variant?: 'text' | 'image'; // New prop to switch between text and image versions
}

export const InZoneLogo: React.FC<InZoneLogoProps> = ({ 
  size = 'medium', 
  showJapanese = true,
    ...
    return (
      <View style={styles.container}>
        <Image 
          ...
          source={require('../../assets/images/inzone-logo.png')} 
    ...
    <View style={styles.container}>
      ...
      {showText && (
        <View style={styles.logoContainer}>
          <Text style={styles.capitalI}>I</Text>
          <Text style={styles.lowercase}>nZone</Text>
        </View>
      )}
    </View>
  );
...
const getStyles = (size: 'small' | 'medium' | 'large', showText: boolean = true) => {
  ...
  return StyleSheet.create({
    capitalI: {
      ...
      fontWeight: '700',
      // Make capital I the same height as lowercase letters
